...
async function getMonthData() {
 ...
 // console.log(new_prices);
  ...
  function resetBorder(){
    per_day.style.borderColor = "buttonborder";
    per_week.style.borderColor = "buttonborder";
    per_month.style.borderColor = "buttonborder";
  }

  per_week.addEventListener("click", () => {

    resetBorder()
    per_week.style.borderColor = "red";
    destroyChart();
    clearArray()
  ...
  per_month.addEventListener("click", () => {
    resetBorder()
    per_month.style.borderColor = "red";
    destroyChart();
    clearArray()
